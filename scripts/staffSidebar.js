document.addEventListener('DOMContentLoaded', function() {
  ...
  const pageMap = {
    dashboard: '../../my/staff/dashboard.php',
    reports: '../../my/staff/reports.php',
    controlPanel: '../../my/staff/control.php',
    usersPanel: '../../my/staff/users.php',
    account: '../../my/staff/account.php'
  };
