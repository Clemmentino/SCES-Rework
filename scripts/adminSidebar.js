document.addEventListener('DOMContentLoaded', function() {
  ...
  const pageMap = {
    dashboard: '../../my/admin/dashboard.php',
    reports: '../../my/admin/reports.php',
    controlPanel: '../../my/admin/control.php',
    usersPanel: '../../my/admin/users.php',
    account: '../../my/admin/account.php'
  };
