...
$role = $_SESSION['role'] ?? 'staff'; // Default role for testing, change as needed
?>
...
<div class="sidebar" id="sidebar">
  <div class="nav-top">
    <div class="nav-logo nav-item">
      <img src="../../img/SCES solo.png" alt="Logo">
      <span style="font-size: 10px; font-weight: bold; font-family: 'Poppins', sans-serif;">
        SMART CAMPUS <br>ENERGY SYSTEM
      </span>
    </div>
...
<div class="mobile-nav">
  ...
  <header class="top-navbar">
    ...
    <nav class="slide-menu">
      <div class="menu-link" data-target="account">
  ...
  <nav class="bottom-navbar">
    <?php if ($role === 'admin' || $role === 'technician') : ?>
    <div class="bottom-nav-item" data-target="dashboard">
      <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-columns-gap" viewBox="-1.7 -0.4 20 17">
    ...
    <?php if ($role === 'admin' || $role === 'staff') : ?>
    <div class="bottom-nav-item" data-target="reports">
    ...
    <?php if ($role === 'admin' || $role === 'staff' || $role === 'technician') : ?>
    <div class="bottom-nav-item" data-target="controlPanel">
    ...
    <?php if ($role === 'admin') : ?>
    <div class="bottom-nav-item" data-target="usersPanel">
