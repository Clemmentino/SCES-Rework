...
<div class="sidebar" id="sidebar">
  <div class="nav-top">
    <div class="nav-logo nav-item">
      ...
      <span style="font-size: 10px; font-weight: bold; font-family: 'Poppins', sans-serif;">SMART CAMPUS <br>ENERGY
        SYSTEM</span>
    </div>
...
<div class="mobile-nav">
  ...
  <nav class="bottom-navbar">
    <div class="bottom-nav-item active" data-target="dashboard">
    ...
    <div class="bottom-nav-item" data-target="reports">
      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-earmark-text"
        viewBox="0 0 16 16">
        <path
          d="M5.5 7a.5.5 0 0 0 0 1h5a.5.5 0 0 0 0-1zM5 9.5a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 0 1h-5a.5.5 0 0 1-.5-.5m0 2a.5.5 0 0 1 .5-.5h2a.5.5 0 0 1 0 1h-2a.5.5 0 0 1-.5-.5" />
        <path
